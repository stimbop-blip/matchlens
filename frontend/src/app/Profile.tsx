    ...
    <div className="space-y-3 pb-2">
      <motion.section initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="glass neon p-4">
        <div className="flex items-center gap-3">
          <div className="h-[84px] w-[84px] overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)]/80 flex items-center justify-center text-xs text-[var(--text-secondary)]">
            3D off
          </div>
