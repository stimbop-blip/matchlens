WELCOME_TEXT = (
    ...
    "<i>Без обещаний гарантированного заработка. Только дисциплина, риск-менеджмент и решения на основе данных.</i>"
)
...
TARIFFS_TEXT = (
    ...
    "<b>Premium</b> — основной тариф: полная Premium-лента, уведомления и разборы\n"
    "<b>VIP</b> — максимум: VIP-сигналы, ранний доступ, live/hot picks и расширенные разборы\n\n"
