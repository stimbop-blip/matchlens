...
class UserSettings(Base):
    ...
    notify_report_daily: Mapped[bool] = mapped_column(Boolean, default=True)
    notify_report_weekly: Mapped[bool] = mapped_column(Boolean, default=True)
    notify_report_monthly: Mapped[bool] = mapped_column(Boolean, default=False)
